...
void TIM_SetCompare1(TIM_TypeDef* TIMx, uint32_t Compare1);										//设置CCR
...
void TIM_ICInit(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct);						//初始化输入捕获
void TIM_ICStructInit(TIM_ICInitTypeDef* TIM_ICInitStruct);										//默认初始化
void TIM_PWMIConfig(TIM_TypeDef* TIMx, TIM_ICInitTypeDef* TIM_ICInitStruct);					//初始化输入捕获为交叉输入模式 仅限通道1和2
uint32_t TIM_GetCapture1(TIM_TypeDef* TIMx);													//拿到CCR
uint32_t TIM_GetCapture2(TIM_TypeDef* TIMx);
uint32_t TIM_GetCapture3(TIM_TypeDef* TIMx);
uint32_t TIM_GetCapture4(TIM_TypeDef* TIMx);
void TIM_SetIC1Prescaler(TIM_TypeDef* TIMx, uint16_t TIM_ICPSC);								//设置分频值
...
void TIM_CtrlPWMOutputs(TIM_TypeDef* TIMx, FunctionalState NewState);							//高级定时器使能
...
/* Clocks management **********************************************************/
void TIM_InternalClockConfig(TIM_TypeDef* TIMx);												//配置定时器使用内部时钟
...
void TIM_SelectInputTrigger(TIM_TypeDef* TIMx, uint16_t TIM_InputTriggerSource);				//选择从模式输入的触发源
void TIM_SelectOutputTrigger(TIM_TypeDef* TIMx, uint16_t TIM_TRGOSource);
void TIM_SelectSlaveMode(TIM_TypeDef* TIMx, uint16_t TIM_SlaveMode);							//配置从模式的功能
