...
/* ===================== Types ===================== */
typedef enum { SRC_NONE=0, SRC_RC=1, SRC_UPPER=2, } cmd_src_t;
typedef enum { UPPER_NONE=0, UPPER_RPM=1, UPPER_CONFIG=2, } cmd_upper_t;
typedef enum { CMD_STOP=0, CMD_SETPOINT=1, } cmd_type_t;
